...
def main():
    ...
    frame1a = tk.Frame()
    frame1a = tk.Frame(root, width=300, height=200, borderwidth=10, padx=10, pady=10, relief="sunken")
    frame1a.pack()
    frame1a.place(x=0,y=0)

    frame1b = tk.Frame()
    frame1b = tk.Frame(root, width=300, height=200, borderwidth=10, padx=10, pady=10, relief="sunken")
    frame1b.pack()
    frame1b.place(x=400, y=0)

    frame2 = tk.Frame()
    frame2 = tk.Frame(root, width=800, height=200, borderwidth=10, padx=10, pady=10, relief="sunken")
    frame2.pack()
    frame2.place(y=200)

    frame3 = tk.Frame()
    frame3 = tk.Frame(root, width=800, height=200, borderwidth=10, padx=10, pady=10, relief="sunken")
    frame3.pack()
    frame3.place(y=400)
    ...
    e2.place(anchor="center")

    b1 = tk.Button(frame2, text='Reply', command=lambda: reply_func(e2,e1))
    b1.pack(side="left", fill="both", expand=True) 
    b2 = tk.Button(frame2, text='Clean', command=lambda: clean_func(e2,e1))
    b2.pack(side="left", fill="both", expand=True)
    b3 = tk.Button(frame3, text='Quit', command=lambda: quit_func(b3))
